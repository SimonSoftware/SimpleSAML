...
class SAMLBuilder
{
     ...
     */
    private function addExtensions(Configuration $metadata, \SAML2\XML\md\RoleDescriptor $e)
    {
     ...
     */
    private function addCertificate(\SAML2\XML\md\RoleDescriptor $rd, Configuration $metadata)
    {
